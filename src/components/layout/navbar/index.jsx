...
import { User, Briefcase, Feather, Bookmark, GitHub } from 'react-feather'
    ...
    <div className="container">
      <NavbarElement>
          <NavbarLogo>
            <h3>
              <Link to="/">
                <Bookmark className="align-middle"/> <span className="align-middle"> {siteTitle} </span>
              </Link>
            </h3>
          </NavbarLogo> 
          <div className="main-navigation">
            <NavbarList>
              ...
              <li><Link to="/works" className="lined-link" activeClassName="active"> <Briefcase /> <span> Stats </span> </Link></li>  
