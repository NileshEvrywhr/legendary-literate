			...
			<FooterStyle>					
					...
					<div className="box">
						...
						<CopyRight className="text-dark">
							© <span>Built by <a href="https://nilesheverywhere.com" rel="noopener">{data.SiteAuthor}</a> • Theme by {` `} <a href="https://twitter.com/AbdaliDahir" rel="noopener">AbdaliDahir</a></span>
						</CopyRight>
					</div>
				</ContainerLayout>
			</FooterStyle>
